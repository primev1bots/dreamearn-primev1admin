...
const TelegramNotifier: React.FC = () => {
  ...
  useEffect(() => {
    const checkBackendStatus = async () => {
      try {
        const response = await fetch("https://d6dddbc3-5995-4e04-94ef-16627fc12518.e1-us-east-azure.choreoapps.dev/api/health");
        if (response.ok) {
  ...
  const testBotToken = async (token: string): Promise<boolean> => {
    try {
      const response = await fetch("https://d6dddbc3-5995-4e04-94ef-16627fc12518.e1-us-east-azure.choreoapps.dev/api/test-notification", {
        method: "POST",
  ...
  const sendNotification = async () => {
    ...
    try {
      ...
      const res = await fetch("https://d6dddbc3-5995-4e04-94ef-16627fc12518.e1-us-east-azure.choreoapps.dev/api/send-notification", {
        method: "POST",
        headers: { 
